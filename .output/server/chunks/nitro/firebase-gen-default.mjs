...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"C:\\Users\\Orisu\\Desktop\\DATN 2023\\SUMMER\\code\\shoes-web-user\\.data\\kv"}));
...
const _lazy_oSwO8z = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_oSwO8z, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_oSwO8z, lazy: true, middleware: false, method: undefined }
];
...
export { send as a, setResponseStatus as b, setResponseHeaders as c, dr as d, eventHandler as e, useRuntimeConfig as f, getResponseStatus as g, getQuery as h, createError$1 as i, joinURL as j, getRouteRules as k, getResponseStatusText as l, server as m, setResponseHeader as s, useNitroApp as u, wn as w };
//# sourceMappingURL=firebase-gen-default.mjs.map

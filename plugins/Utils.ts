...
export default defineNuxtPlugin((nuxtApp) => {
    ...
    app.provide("removeSpecialChars", (val: string) => val.replace(/[^\w\sÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚĂăĐđĨĩŨũƠơƯưẠạẢảẤấẦầẨẩẪẫẬậẮắẰằẲẳẴẵẶặẸẹẺẻẼẽẾếỀềỂểỄễỆệỈỊịỌọỎỏỐốỒồỔổỖỗỘộỚớỜờỞởỠỡỢợỤụỦủỨứỪừỬửỮữỰựỲỳỴỵỶỷỸỹ]/g, ""));
});
<template>
  <div class="min-h-screen flex flex-col items-center justify-center bg-cover" style="
    ...
    <div
      ...
      <div class="mt-3">
        <a-form ref="formRef" class="w-full sm:max-w-[300px] lg:max-w-[500px] relative" :model="formState" name="basic"
          layout="vertical">
        ...
        <div class="mt-5"><a class="text-blue-600 hover:text-blue-700" @click="showModal">Quên mật khẩu ?</a></div>

        <a-modal v-model:visible="visible" title="Quên mật khẩu" okText="Gửi" cancelText="Huỷ" @ok="handleOk">
          <a-form ref="formRef" style="margin: 0 auto" :model="formForgotPass" name="basic" layout="vertical">
            <div class="flex flex-col">
